...
var _DomHandler = _interopRequireDefault(require("primereact/components/utils/DomHandler"));

var _ObjectUtils = _interopRequireDefault(require("primereact/components/utils/ObjectUtils"));

var _FilterUtils = _interopRequireDefault(require("primereact/components/utils/FilterUtils"));
...
var _Tooltip = _interopRequireDefault(require("primereact/components/tooltip/Tooltip"));
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames.default)('p-dropdown p-component', this.props.className, {
        ...
        'p-inputwrapper-focus': this.focus && this.state.overlayVisible,
